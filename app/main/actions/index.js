...
function initActions() {
    ...
    electron_1.ipcMain.handle('load-json', loadJson);
...
function loadJson(event, groupPath) {
    return __awaiter(this, void 0, void 0, function () {
        var filePath, file, filePath, file, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 5, , 6]);
                    if (!fs.existsSync(groupPath)) return [3 /*break*/, 2];
                    filePath = path.join(groupPath, '_index.json');
                ...
                case 5:
                    e_1 = _a.sent();
                    console.error('load-json failed:', e_1);
