export const quasiQuests = [
    65973, 66024, 66025, 69566, // Gold Saucer
    69296, 69377, 69508, 69578, // Firmament Phases
    67635, 68477, 69139, 69711, // Splendors
    67643, 68456, 69140, 69710, // Sightseeing
    ...
    67642, 68457, 69138, 69706, // Leves
    68478, 68148, 68149, // Eureka
    69478, 69630, 69577, // Gangos
    68479, 69198, 69707, // Minstrel
