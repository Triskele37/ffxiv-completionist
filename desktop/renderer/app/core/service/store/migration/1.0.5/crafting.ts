...
function migrateCrafterGroups(store: ChangeStore, crafter: string): void {
    ...
    store.moveGroup(`${HOUSING}.tables-rugs`, `${HOUSING}.tables-and-rugs`);
    ...
    store.moveGroup(`${SHARED}.tribal-quests`, SOCIETY);
    store.moveGroup(`${SOCIETY}.ixal`, `${SOCIETY}.ixal-quests`);
    store.moveGroup(`${SOCIETY}.moogle`, `${SOCIETY}.moogle-quests`);
    store.moveGroup(`${SOCIETY}.namazu`, `${SOCIETY}.namazu-quests`);
    store.moveGroup(`${SOCIETY}.dwarf`, `${SOCIETY}.dwarf-quests`);
    store.moveGroup(`${SOCIETY}.loporrit`, `${SOCIETY}.loporrit-quests`);
...
function migrateCarpenter(store: ChangeStore): void {
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.6-10', [
        [1821, 1017], [1996, 1016], [1892, 1018], [1997, 1020], [2572, 1019], [1893, 1021], [2228, 1022], [5364, 1023], [1604, 1024], [1822, 1025],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-2', [
        [5377, 30861], [9086, 30941], [15559, 31919], [9087, 30942], [15560, 31920], [9090, 30945], [9089, 30944], [15564, 31924], [9302, 30906],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.master-recipes.other-master-recipes', [
        [21800, 30305], [8367, 30461], [8359, 30453], [8368, 30462], [8386, 30480], [8388, 30482], [8360, 30454],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.class.class-quests', [
        [17878, 32272], [17880, 32273], [17882, 32274], [17884, 32275],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.collectables.50-60', [
        [30970, 34047], [30971, 34048], [30972, 34049], [30973, 34050], [30974, 34051], [30975, 34052],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.collectables.61-70', [
        [30976, 34053], [30977, 34054], [30978, 34055], [30979, 34056], [30980, 34057],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.collectables.71-80', [
        [30981, 34058], [30982, 34059], [30983, 34060], [30984, 34061], [31652, 34423],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.collectables.81-90', [
        [35626, 34712], [35627, 34713], [35628, 34714], [35629, 34715], [35630, 34716], [36619, 34901],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.outdoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.tables-rugs', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.tabletop', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.housing.wall-mounted', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.sidequests.skysteel-tools', [
        [29645, 33761], [29653, 33769], [31101, 34359], [31109, 34367], [31750, 34587],
    ]);
    store.changeKeys('overall.logs.crafting-log.carpenter.special-recipes.sidequests.splendorous-tools', [
        [38756, 35401], [38764, 35409], [39773, 35600], [39781, 35608], [41254, 35683], [41262, 35691],
    ]);
}

function migrateBlacksmith(store: ChangeStore): void {
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.1-5', [
        [5056, 1], [2546, 2], [1602, 3], [2355, 4], [5091, 5], [1750, 6], [2380, 7], [2315, 9], [2430, 8], [9184, 2071], [2328, 10],
        [2341, 11], [2367, 12],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.11-15', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.16-20', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.21-25', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.31-35', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.36-40', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.41-45', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.6-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.master-recipes.other-master-recipes', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.class.class-quests', [
        [17886, 32276], [17888, 32277], [17890, 32278], [17892, 32279],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.collectables.50-60', [
        [30985, 34062], [30986, 34063], [30987, 34064], [30988, 34065], [30989, 34066], [30990, 34067],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.collectables.61-70', [
        [30991, 34068], [30992, 34069], [30993, 34070], [30994, 34071], [30995, 34072],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.collectables.71-80', [
        [30996, 34073], [30997, 34074], [30998, 34075], [30999, 34076], [31653, 34424],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.collectables.81-90', [
        [35631, 34717], [35632, 34718], [35633, 34719], [35634, 34720], [35635, 34721], [36620, 34902],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.outdoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.tables-rugs', [
        [6602, 1827], [6606, 1831], [6625, 1850], [6564, 1790], [6626, 1851], [6630, 1855], [6620, 1845], [6632, 1857], [13071, 2828], [27284, 4536], [28973, 4616],
        [37374, 5444],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.tabletop', [
        [20747, 3733], [28145, 4568], [29683, 4611], [30402, 4634], [33266, 4702], [32235, 4659], [35555, 5359], [38616, 5479], [40629, 5524], [39390, 5511],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.housing.wall-mounted', [
        [8811, 2118], [6663, 1881], [6668, 1886], [8805, 2113], [7082, 1965], [30406, 4638], [30400, 4632], [35577, 5368], [37362, 5438], [39395, 5510],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.sidequests.skysteel-tools', [
        [29646, 33762], [29654, 33770], [31102, 34360], [31110, 34368], [31751, 34588],
    ]);
    store.changeKeys('overall.logs.crafting-log.blacksmith.special-recipes.sidequests.splendorous-tools', [
...
function migrateArmorer(store: ChangeStore): void {
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.1-5', [
        [5056, 170], [5081, 172], [5091, 171], [5071, 173], [2468, 174], [2494, 175], [2226, 176],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.11-15', [
        [2495, 185], [2673, 188], [3026, 187], [5057, 189], [3775, 190], [5072, 192], [5092, 191], [3544, 193], [5082, 194], [7021, 1590], [2470, 197],
        [2496, 196], [2231, 195],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.16-20', [
        [2680, 198], [3550, 199], [2236, 200], [2471, 201], [2497, 202], [2708, 204], [3793, 203], [2239, 209], [2712, 208], [3045, 207], [3563, 206],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.21-25', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.31-35', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.36-40', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.41-45', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.6-10', [
        [3011, 177], [3767, 178], [2656, 179], [2662, 180], [2469, 182], [3540, 181], [2230, 184], [2664, 183],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-2', [
        [9082, 30937], [9026, 30868], [9036, 30874], [9027, 30869], [9037, 30875], [9028, 30870], [9038, 30876], [36122, 31929], [9030, 30872], [9040, 30878],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.master-recipes.other-master-recipes', [
        [21800, 30319], [8454, 30492], [8455, 30493],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.class.class-quests', [
        [17894, 32280], [17896, 32281], [17898, 32282], [17900, 32283],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.collectables.50-60', [
        [31000, 34077], [31001, 34078], [31002, 34079], [31003, 34080], [31004, 34081], [31005, 34082],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.collectables.61-70', [
        [31006, 34083], [31007, 34084], [31008, 34085], [31009, 34086], [31010, 34087],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.collectables.71-80', [
        [31011, 34088], [31012, 34089], [31013, 34090], [31014, 34091], [31654, 34425],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.collectables.81-90', [
        [35636, 34722], [35637, 34723], [35638, 34724], [35639, 34725], [35640, 34726], [36621, 34903],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.outdoor', [
        [6486, 1733], [7996, 2045], [12235, 2401], [6485, 1732], [6475, 1722], [28162, 4575], [33299, 4721], [41144, 5583], [41429, 5585],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.tables-rugs', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.tabletop', [
        [6636, 1861], [6652, 1877], [8798, 2112], [27278, 4533], [20748, 3734], [27286, 4538], [28984, 4608], [33292, 4725],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.housing.wall-mounted', [
        [6670, 1888], [27285, 4537], [28133, 4564], [30401, 4633], [30403, 4635], [40656, 5540], [40631, 5526], [40655, 5539], [41113, 5580], [40645, 5546],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.sidequests.other', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.sidequests.skysteel-tools', [
        [29647, 33763], [29655, 33771], [31103, 34361], [31111, 34369], [31752, 34589],
    ]);
    store.changeKeys('overall.logs.crafting-log.armorer.special-recipes.sidequests.splendorous-tools', [
        [38758, 35403], [38766, 35411], [39775, 35602], [39783, 35610], [41256, 35685], [41264, 35693],
    ]);
}

function migrateGoldsmith(store: ChangeStore): void {
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.1-5', [
        [5062, 663], [1681, 664], [2056, 665], [5086, 666], [2106, 667], [4305, 668], [4091, 669],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.11-15', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.16-20', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.21-25', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.31-35', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.36-40', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.41-45', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.6-10', [
        [5258, 670], [4197, 671], [4422, 672], [4421, 673], [2443, 674], [4306, 675], [2107, 677], [4307, 676], [1683, 680], [2057, 678], [4093, 679],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.master-recipes.other-master-recipes', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.class.class-quests', [
        [17902, 32284], [17904, 32285], [17906, 32286], [17908, 32287],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.collectables.50-60', [
        [31015, 34092], [31016, 34093], [31017, 34094], [31018, 34095], [31019, 34096], [31020, 34097],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.collectables.61-70', [
        [31021, 34098], [31022, 34099], [31023, 34100], [31024, 34101], [31025, 34102],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.collectables.71-80', [
        [31026, 34103], [31027, 34104], [31028, 34105], [31029, 34106], [31655, 34426],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.collectables.81-90', [
        [35641, 34727], [35642, 34728], [35643, 34729], [35644, 34730], [35645, 34731], [36622, 34904],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.outdoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.tables-rugs', [
        [6609, 1834], [6614, 1839], [6633, 1858], [33281, 4712], [35576, 5372], [37361, 5436], [38595, 5486], [41089, 5574],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.tabletop', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.housing.wall-mounted', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.sidequests.other', [
        [28818, 33623], [28828, 33633], [28833, 33638], [28838, 33643], [28843, 33648], [28848, 33653], [28858, 33663], [28868, 33673], [28873, 33678],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.sidequests.skysteel-tools', [
        [29648, 33764], [29656, 33772], [31104, 34362], [31112, 34370], [31753, 34590],
    ]);
    store.changeKeys('overall.logs.crafting-log.goldsmith.special-recipes.sidequests.splendorous-tools', [
...
function migrateLeatherworker(store: ChangeStore): void {
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.1-5', [
        [5275, 302], [2631, 303], [3516, 305], [3740, 304], [3741, 307], [2653, 311], [3530, 309], [3761, 310], [3310, 315], [3762, 313], [27634, 4477],
        [4304, 314],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.11-15', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.16-20', [
        [3547, 350], [5277, 353], [2672, 354], [3774, 355], [4097, 356], [4099, 357], [1688, 360], [3549, 358], [3552, 359], [2697, 363], [3784, 361],
        [3562, 365], [4435, 364],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.21-25', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.31-35', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.36-40', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.41-45', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.6-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.master-recipes.other-master-recipes', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.class.class-quests', [
        [17910, 32288], [17912, 32289], [17914, 32290], [17916, 32291],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.collectables.50-60', [
        [31030, 34107], [31031, 34108], [31032, 34109], [31033, 34110], [31034, 34111], [31035, 34112],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.collectables.61-70', [
        [31036, 34113], [31037, 34114], [31038, 34115], [31039, 34116], [31040, 34117],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.collectables.71-80', [
        [31041, 34118], [31042, 34119], [31043, 34120], [31044, 34121], [31656, 34427],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.collectables.81-90', [
        [35646, 34732], [35647, 34733], [35648, 34734], [35649, 34735], [35650, 34736], [36623, 34905],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.fixtures', [
        [7148, 2015], [6445, 1695], [6444, 1694], [6443, 1693], [6473, 1720],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.outdoor', [
        [9749, 2188],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.tables-rugs', [
        [6631, 1856], [6682, 1900], [6675, 1893], [6678, 1896], [6674, 1892], [6685, 1903], [7092, 1975], [35556, 5382],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.tabletop', [
        [6655, 1880], [7966, 2025],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.housing.wall-mounted', [
        [6672, 1890],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.sidequests.other', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.sidequests.skysteel-tools', [
        [29649, 33765], [29657, 33773], [31105, 34363], [31113, 34371], [31754, 34591],
    ]);
    store.changeKeys('overall.logs.crafting-log.leatherworker.special-recipes.sidequests.splendorous-tools', [
...
function migrateWeaver(store: ChangeStore): void {
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.1-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.11-15', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.16-20', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.21-25', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.31-35', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.36-40', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.41-45', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.6-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.master-recipes.other-master-recipes', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.class.class-quests', [
        [17918, 32292], [17920, 32293], [17922, 32294], [17924, 32295],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.collectables.50-60', [
        [31045, 34122], [31046, 34123], [31047, 34124], [31048, 34125], [31049, 34126], [31050, 34127],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.collectables.61-70', [
        [31051, 34128], [31052, 34129], [31053, 34130], [31054, 34131], [31055, 34132],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.collectables.71-80', [
        [31056, 34133], [31057, 34134], [31058, 34135], [31059, 34136], [31657, 34428],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.collectables.81-90', [
        [35651, 34737], [35652, 34738], [35653, 34739], [35654, 34740], [35655, 34741], [36624, 34906],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.indoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.outdoor', [
        [6482, 1729], [30388, 4624], [32242, 4670], [32243, 4671], [38618, 5487],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.tables-rugs', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.tabletop', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.housing.wall-mounted', [
        [27274, 4532], [32224, 4665], [30389, 4625], [38591, 5481], [38592, 5482],
    ]);
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.sidequests.other', [
    ...
    store.changeKeys('overall.logs.crafting-log.weaver.special-recipes.sidequests.restoration', [
...
function migrateAlchemist(store: ChangeStore): void {
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.6-10', [
        [4565, 1109], [5510, 1110], [2144, 1111], [1959, 1112], [5482, 1113], [5504, 1114], [5515, 1115], [2145, 1116],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.master-recipes.other-master-recipes', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.class.class-quests', [
        [17926, 32296], [17928, 32297], [17930, 32298], [17932, 32299],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.collectables.50-60', [
        [31060, 34137], [31061, 34138], [31062, 34139], [31063, 34140], [31064, 34141], [31065, 34142],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.collectables.61-70', [
        [31066, 34143], [31067, 34144], [31068, 34145], [31069, 34146], [31070, 34147],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.collectables.71-80', [
        [31071, 34148], [31072, 34149], [31073, 34150], [31074, 34151], [31658, 34429],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.collectables.81-90', [
        [35656, 34742], [35657, 34743], [35658, 34744], [35659, 34745], [35660, 34746], [36625, 34907],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.fixtures', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.indoor', [
        [6594, 1820], [6595, 1821], [9734, 2177], [7979, 2034], [7975, 2030], [8782, 2099], [7974, 2029], [33282, 4713], [28131, 4587], [30394, 4629], [32228, 4654],
        [32221, 4656],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.other', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.outdoor', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.tables-rugs', [
        [23893, 3771], [33276, 4708], [41111, 5579],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.tabletop', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.housing.wall-mounted', [
        [7970, 2026], [23894, 3772], [8807, 2115], [8809, 2117], [24508, 3796], [28975, 4603], [35563, 5363], [38577, 5477], [40646, 5536], [37359, 5437],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.others.ornaments-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.others.ornaments-2', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.sidequests.skysteel-tools', [
        [29651, 33767], [29659, 33775], [31107, 34365], [31115, 34373], [31756, 34593],
    ]);
    store.changeKeys('overall.logs.crafting-log.alchemist.special-recipes.sidequests.splendorous-tools', [
        [38762, 35407], [38770, 35415], [39779, 35606], [39787, 35614], [41260, 35689], [41268, 35697],
    ]);
}

function migrateCulinarian(store: ChangeStore): void {
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.1-5', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.11-15', [
        [4857, 924], [4855, 925], [4640, 926], [4865, 927], [4735, 928], [4736, 929], [4641, 930], [4682, 931], [4863, 932], [4861, 933], [4708, 934],
        [4661, 936], [4666, 935],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.16-20', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.21-25', [
        [4643, 951], [4698, 953], [4722, 950], [4746, 952], [4652, 956], [4684, 955], [4730, 954], [4662, 958], [4699, 959], [4710, 957], [4749, 960],
        [2595, 1500], [4711, 961],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.26-30', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.31-35', [
        [4860, 973], [4685, 974], [4700, 975], [4645, 977], [4691, 976], [4670, 979], [4712, 978], [4654, 981], [4701, 980], [2598, 1501], [4719, 982],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.36-40', [
        [4756, 983], [4686, 984], [4677, 986], [4724, 985], [4663, 987], [4702, 988], [4692, 990], [4687, 989], [6143, 1502], [4733, 992], [4747, 991],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.41-45', [
        [4646, 993], [4671, 994], [4757, 995], [4720, 996], [4679, 1503], [4693, 997], [4664, 998], [4703, 1000], [4727, 999],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.46-50', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.51-55', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.56-60', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.6-10', [
        [4852, 912], [4745, 913], [4826, 915], [4853, 914], [4658, 916], [4657, 918], [4689, 917], [4659, 919], [4673, 920], [4854, 921], [2589, 1497],
        [4681, 922], [4726, 923],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.61-65', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.66-70', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.71-75', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.76-80', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.81-85', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.level-based.86-90', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-1', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.mr-10', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-2', [
        [9332, 30866], [9331, 30865], [9335, 30867], [9330, 30864],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-3', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-4', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-5', [
        [19818, 32418], [21088, 32460], [21087, 32459], [19836, 32419], [19810, 32417],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-6', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-7', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.master-recipes-8', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.master-recipes.mr-9', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.class.class-quests', [
        [17934, 32300], [17936, 32301], [17938, 32302], [17940, 32303],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.collectables.50-60', [
        [31075, 34152], [31076, 34153], [31077, 34154], [31078, 34155], [31079, 34156], [31080, 34157],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.collectables.61-70', [
        [31081, 34158], [31082, 34159], [31083, 34160], [31084, 34161], [31085, 34162],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.collectables.71-80', [
        [31086, 34163], [31087, 34164], [31088, 34165], [31089, 34166], [31659, 34430],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.collectables.81-90', [
        [35661, 34747], [35662, 34748], [35663, 34749], [35664, 34750], [35665, 34751], [36626, 34908],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.housing.indoor', [
        [33259, 4699],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.housing.outdoor', [
        [28166, 4579], [28167, 4580], [28168, 4581], [28171, 4584], [32246, 4674],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.housing.tabletop', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.sidequests.restoration', [
    ...
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.sidequests.skysteel-tools', [
        [29652, 33768], [29660, 33776], [31108, 34366], [31116, 34374], [31757, 34594],
    ]);
    store.changeKeys('overall.logs.crafting-log.culinarian.special-recipes.sidequests.splendorous-tools', [
        [38763, 35408], [38771, 35416], [39780, 35607], [39788, 35615], [41261, 35690], [41269, 35698],
    ]);
}

function migrateShared(store: ChangeStore): void {
    store.changeKeys('overall.logs.crafting-log.shared.class.crystarium-deliveries', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.class.studium', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.tribal-quests.dwarf', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.tribal-quests.ixal', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.tribal-quests.loporrit', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.tribal-quests.moogle', [
    ...
    store.changeKeys('overall.logs.crafting-log.shared.tribal-quests.namazu', [
