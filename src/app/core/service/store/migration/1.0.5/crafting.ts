...
function migrateCarpenter(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.carpenter.level-based.46-50', [
        [1937, 1095], [1867, 1096], [2414, 1524], [2044, 1911], [2582, 1098], [3908, 1097], [1872, 1100], [1942, 1099], [5378, 1526], [1879, 1530], [1949, 1529],
        [2415, 1531], [2466, 1532], [5379, 1527], [5574, 1528], [1953, 1534], [2304, 1533], [3947, 1535], [8168, 2020], [14182, 2865], [7568, 1941],
    ]);
...
function migrateArmorer(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.armorer.master-recipes.master-recipes-2', [
        [9082, 30937], [9026, 30868], [9036, 30874], [9027, 30869], [9037, 30875], [9028, 30870], [9038, 30876], [9030, 30872], [9040, 30878],
    ]);
...
function migrateGoldsmith(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.goldsmith.level-based.46-50', [
        ...
        [2923, 1479], [2921, 1480], [6139, 1576], [5213, 1472], [5067, 1473], [5576, 1474], [5588, 1475], [10531, 2413], [2932, 1492], [8704, 2065],
        [10050, 2139], [13262, 2841], [13263, 2842], [4286, 1489], [4284, 1490], [4285, 1493], [4389, 1485], [4390, 1491], [4182, 1486], [4183, 1494],
        [4527, 1487], [4528, 1495],
    ]);
    ...
    store.safeChangeKeys('logs.crafting-log.goldsmith.level-based.86-90', [
        ...
        [34601, 5024], [34602, 5025], [34604, 5027], [34603, 5026], [35367, 5150], [34565, 4988], [34586, 5009], [34587, 5010], [34589, 5012], [34588, 5011],
        [36186, 5315], [34694, 5042], [34692, 5040], [34697, 5045], [34735, 5083], [34736, 5084], [34737, 5085], [34739, 5087], [34738, 5086], [34750, 5098],
        [34751, 5099], [34752, 5100], [34754, 5102], [34753, 5101], [34740, 5088], [34741, 5089], [34742, 5090], [34744, 5092], [34743, 5091], [34745, 5093],
        [34746, 5094], [34747, 5095], [34749, 5097], [34748, 5096], [35388, 5171],
    ]);
    ...
    store.safeChangeKeys('logs.crafting-log.goldsmith.special-recipes.housing.tables-and-rugs', [
        [6609, 1834], [6614, 1839], [6633, 1858], [33281, 4712], [35576, 5372], [38595, 5486], [41089, 5574],
    ]);
...
function migrateLeatherworker(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.leatherworker.level-based.86-90', [
        ...
        [35436, 5219], [35441, 5224], [35443, 5226],
    ]);
...
function migrateWeaver(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.weaver.level-based.41-45', [
        ...
        [27646, 4489], [3406, 1374], [2854, 644], [2852, 646], [3187, 643], [3188, 645], [3185, 647], [3442, 648], [3182, 1375], [2882, 652],
        [13256, 2837], [17462, 2943], [3193, 649], [3201, 651], [3205, 653], [27677, 4521], [17463, 2944], [3680, 655], [3456, 650], [3454, 654],
        [17464, 2945], [2855, 1376],
    ]);
...
function migrateAlchemist(store: ChangeStore): void {
    ...
    store.safeChangeKeys('logs.crafting-log.alchemist.special-recipes.others.ornaments-1', [
        ...
        [33032, 4681], [33033, 4682], [33034, 4683], [33035, 4684], [33036, 4685], [35991, 5347], [35992, 5348], [35993, 5349], [35994, 5350], [35995, 5351],
        [35996, 5352], [35997, 5353], [35998, 5354], [35999, 5355], [37293, 5454], [37294, 5455], [37295, 5456], [37296, 5457], [37297, 5458], [37298, 5459],
        [37299, 5460], [37300, 5461], [37301, 5462],
    ]);
...
function migrateShared(store: ChangeStore): void {
    store.safeChangeKeys('logs.crafting-log.shared.class.crystarium-deliveries', [
        [27240, 33462], [27241, 33463], [27242, 33464], [27245, 33466], [27243, 33465], [27247, 33467],
    ]);
    store.safeChangeKeys('logs.crafting-log.shared.class.studium-deliveries', [
        [35592, 34770], [35593, 34771], [35594, 34772], [35840, 34774], [35595, 34773], [35842, 34775],
    ]);
