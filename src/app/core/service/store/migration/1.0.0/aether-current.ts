...
export function migrateAetherCurrents(store: ChangeStore): void {
    ...
    const CWH = 'overall.travel.aether-currents.hw.coerthas-western-highlands'; //#region
    ...
    const TDF = 'overall.travel.aether-currents.hw.the-dravanian-forelands'; //#region
    ...
    const TSOC = 'overall.travel.aether-currents.hw.the-sea-of-clouds'; //#region
    ...
    const TCM = 'overall.travel.aether-currents.hw.the-churning-mists'; //#region
    ...
    const TDH = 'overall.travel.aether-currents.hw.the-dravanian-hinterlands'; //#region
    ...
    const TP = 'overall.travel.aether-currents.sb.the-peaks'; //#region
    ...
    const TF = 'overall.travel.aether-currents.sb.the-fringes'; //#region
    ...
    const TL = 'overall.travel.aether-currents.sb.the-lochs'; //#region
    ...
    const TRS = 'overall.travel.aether-currents.sb.the-ruby-sea'; //#region
    ...
    const TAS = 'overall.travel.aether-currents.sb.the-azim-steppe'; //#region
    ...
    const YANXIA = 'overall.travel.aether-currents.sb.yanxia'; //#region
    ...
    const LAKELAND = 'overall.travel.aether-currents.shb.lakeland'; //#region
    ...
    const AMH_ARAENG = 'overall.travel.aether-currents.shb.amh-araeng'; //#region
    ...
    const IL_MHEG = 'overall.travel.aether-currents.shb.il-mheg'; //#region
    ...
    const KHOLUSIA = 'overall.travel.aether-currents.shb.kholusia'; //#region
    ...
    const TRG = 'overall.travel.aether-currents.shb.the-raktika-greatwood'; //#region
    ...
    const TT = 'overall.travel.aether-currents.shb.the-tempest'; //#region
