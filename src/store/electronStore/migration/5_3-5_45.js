...
export const migrate_5_3_to_5_45 = () => {
    const overall = new ChangeStore('0.5.45');

    //--------------------------------- Relocation
    overall.move('achievements.battle.dungeons', 'achievements.battle.field-operations', 'were-on-your-side-i');
    overall.move('achievements.battle.dungeons', 'achievements.battle.field-operations', 'were-on-your-side-ii');
    overall.move('achievements.battle.dungeons', 'achievements.battle.field-operations', 'were-on-your-side-iii');
    ...
    // Skysteel Relics
    overall.moveGroup('collectables.relic-gear.skysteel.dragonsung', 'collectables.relic-gear.skysteel-tools');
    ...
    overall.change('gathering-log.fishing.guide.page-33', 'the-priest-of-yxlokwa', 'priest-of-yxlokwa');

    //--------------------------------- Large-scale Re-org (keep post other changes)
    overall.moveGroup('collectables.aesthetician', 'character.character.aesthetician');
    overall.moveGroup('collectables.barding', 'character.companion.barding');
    overall.moveGroup('collectables.mount-guide', 'character.mount-guide');
    overall.moveGroup('collectables.minion-guide', 'character.minion-guide');
    overall.moveGroup('collectables.fashion-accessories', 'character.fashion-accessories');
    overall.moveGroup('collectables.relic-gear', 'character.relic-gear');
    overall.moveGroup('general-logs.blue-mage', 'character.blue-mage');
    overall.moveGroup('collectables.triple-triad-card-list', 'character.gold-saucer.triple-triad-card-list');
    overall.moveGroup('collectables.triple-triad-opponents', 'character.gold-saucer.triple-triad-opponents');
    overall.moveGroup('achievements', 'character.achievements');
    overall.moveGroup('collectables.collection', 'duty.collection');
    overall.moveGroup('quests', 'duty.quests');
    overall.moveGroup('duty.dungeons', 'duty.dutyraid-finder.dungeons');
    overall.moveGroup('duty.guildhests', 'duty.dutyraid-finder.guildhests');
    overall.moveGroup('duty.trials', 'duty.dutyraid-finder.trials');
    overall.moveGroup('duty.raids', 'duty.dutyraid-finder.raids');
    overall.moveGroup('duty.the-hunt', 'duty.dutyraid-finder.the-hunt');
    overall.moveGroup('fates', 'duty.fates');
    overall.moveGroup('general-logs.hunting-log', 'logs.hunting-log');
    overall.moveGroup('general-logs.sightseeing-log', 'logs.sightseeing-log');
    overall.moveGroup('crafting-log', 'logs.crafting-log');
    overall.moveGroup('gathering-log', 'logs.gathering-log');
    overall.moveGroup('collectables.orchestrion-list', 'logs.orchestrion-list');
    overall.moveGroup('collectables.emotes', 'social.emotes');
    overall.moveGroup('fates.eureka', 'duty.exploratory-missions.the-forbidden-land-eureka.notorious-monsters');
