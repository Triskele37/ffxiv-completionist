...
export const Achievements_Quests_Seasonal = function(parent) {
...
const tasks = [
    {
    	...
    	name: "You Must Needs Befriend Them All",
    	points: "20",
    	description: "Obtain all Yo-kai minions.",
    	reward: ""
    }, {
    	...
    	name: "More Inventory Slots, Please",
    	points: "20",
    	description: "Obtain all the Yo-kai weapons.",
    	reward: ""
    }, {
    	name: "End Of Watch",
    	points: "10",
