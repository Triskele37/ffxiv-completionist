export const MiningLogSpecial = {
    ...
    tasks: [
        ...
        //------------------------------------------------------- Dravanian Folklore
        {
            ...
            locations: ["Mother of the Sheave"]
        }, {
            level: "60★",
            name: "Lumythrite Ore",
            zone: "The Churning Mists",
            locations: ["Sothton Walls"]
        },
        //------------------------------------------------------- Abalathian Folklore
        {
            level: "60★",
            name: "Red Alumen",
            zone: "Azys Lla",
            locations: ["Habisphere Control"]
        }, {
            level: "60★",
            name: "Smithsonite Ore",
            zone: "The Sea of Clouds",
            locations: ["Hengr's Crucible"]
        }, {
            level: "60★",
            name: "Meteorite",
            zone: "The Sea of Clouds",
            ...
            name: "Luminium Ore",
            zone: "Azys Lla",
            locations: ["Hyperstellar Downconverter"]
        },
        ...
        //------------------------------------------------------- Vrandtic Folklore
        {
            ...
            name: "Tungsten Ore",
            zone: "The Tempest",
            locations: ["Where the Dry Return"]
        }, {
            level: "80★",
            name: "Prismstone",
            zone: "Il Mheg",
            locations: ["Saint Fathric's Temple"]
        }, {
            level: "80★",
            name: "Beryllium Ore",
            zone: "Il Mheg",
        ...
        //------------------------------------------------------- Ishgard Restoration
        {
            ...
            zone: "The Ruby Sea",
            locations: ["The Turquoise Trench"]
        }, {
            level: "65",
            ...
            zone: "Il Mheg",
            locations: ["Good Jenanna's Grace"]
        }, {
            level: "75",
            ...
            zone: "The Tempest",
            locations: ["Walls of the Forgotten"]
        }, {
            level: "80",
