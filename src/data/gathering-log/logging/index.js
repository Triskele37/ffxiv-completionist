import { DravanianFolklore } from './dravanian-folklore';
import { AbalathianFolklore } from './abalathian-folklore';
import { GyrAbanianFolklore } from './gyr-abanian-folklore';
import { VrandticFolklore } from './vrandtic-folklore';
import { LoggingIshgardRestoration } from './ishgard-restoration';
...
export const Logging = {
    ...
    tasks: [
        ...
        //------------------------------------------------------- 71-75
        {
        	...
        	name: 'Pixie Apple',
        	zone: 'Il Mheg',
        	locations: ['The Church at Dammroen Field']
        }, {
        	level: '71',
        	name: 'Frantoio',
        	zone: 'Lakeland',
        	locations: ['The Chiliad']
        }, {
        	level: '71',
        	name: 'White Oak Log',
        	zone: 'Kholusia',
        	locations: ['The Bright Cliff']
        }, {
        	level: '72',
        ...
        //------------------------------------------------------- 76-80
        {
        	...
        	name: 'Harcot',
        	zone: 'Lakeland',
        	locations: ['Hare Among Giants']
        }, {
        	level: '80',
        	name: 'Lemonette',
        	zone: 'Kholusia',
        	locations: ['Sharptongue Drip']
        }, {
        	level: '80',
