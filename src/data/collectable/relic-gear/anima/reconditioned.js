...
export const Collectables_Relic_Gear_Anima_Reconditioned = function(parent) {
    return new DataGroup("Reconditioned", parent).initializeTasks(tasks);
};
...
const tasks = [
    ...
    {
        name: "Sword of the Twin Thegns & Shield of the Twin Thegns",
        job: "Paladin",
        slot: "Weapon",
        iLvl: "240",
    },
