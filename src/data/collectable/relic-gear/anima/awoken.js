...
export const Collectables_Relic_Gear_Anima_Awoken = function(parent) {
    return new DataGroup("Awoken", parent).initializeTasks(tasks);
};
...
const tasks = [
    ...
    {
        name: "Hauteclaire Awoken & Prytwen Awoken",
        job: "Paladin",
		slot: "Weapon",
		iLvl: "200",
    },
