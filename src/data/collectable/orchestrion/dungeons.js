...
export const OrchestrionDungeon = {
    name: "Dungeons",
    columns: OrchestrionColumnConfig,
    tasks: [{
            "number": 1,
            "roll": "A Light in the Storm",
        ...
        {
            "number": 48,
            "roll": "In the Belly of the Beast",
            "method": "Obtained in Mt. Gulg",
            "unlock": "Drops in Mt. Gulg"
        },
        {
            "number": 49,
            "roll": "Mortal Instants",
