...
export const OrchestrionTrial = {
    name: "Trials",
    columns: OrchestrionColumnConfig,
    tasks: [{
            "number": 1,
            "roll": "Torn from the Heavens",
        ...
        {
            "number": 22,
            "roll": "The Hand That Gives the Rose",
        ...
        {
            "number": 32,
            "roll": "Wayward Daughter",
            "method": "The Minstrel's Ballad: Tsukuyomi's Pain",
            "unlock": "Level 70??? Alchemist (Master Alchemist VI) from Faded Copy of Under the Moonlight"
        },
        {
            "number": 33,
            "roll": "Savage of the Ancient Forest",
            "method": "Exchange",
            "unlock": "Available for Exchange in Kugane"
        },
        {
            "number": 34,
            "roll": "Proof of a Hero - Monster Hunter World Version",
            "method": "Raid Reward",
