...
export const Logs_Gathering_Log_Quarrying_Special_Vrandtic_Folklore = function(parent) {
...
const tasks = [
    ...
    {
        "level": "80★★★",
        "name_en": "Solstice Stone",
        "zone": "Il Mheg",
        "closestTeleport": "Wolekdorf",
        "coordinates": "(x36,y9)",
        "nodeTimer": "Legendary (2AM/PM), Unlocked w/ Geological Folklore - Vrandtic"
    }
];
