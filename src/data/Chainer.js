export class Chainer {
    ...
    mapGroupLink(linkedPath, linkedID) {
        ...
        let expandedPath;
        switch(linkedPath[0]) {
            case 'q': expandedPath = 'duty.quests'; break;
            case 'a': expandedPath = 'character.achievements'; break;
            case 't': expandedPath = 'character.character.title'; break;
            case 'e': expandedPath = 'social.emotes'; break;
            case 'hl': expandedPath = 'logs.hunting-log'; break;
            case 'h': expandedPath = 'duty.dutyraid-finder.the-hunt'; break;
            case 'dt': expandedPath = 'duty.dutyraid-finder.trials'; break;
            case 'dr': expandedPath = 'duty.dutyraid-finder.raids'; break;
            case 'bsf': expandedPath = 'duty.exploratory-missions.the-bozjan-southern-front'; break;
            case 'fle': expandedPath = 'duty.exploratory-missions.the-forbidden-land-eureka'; break;
            case 'br': expandedPath = 'character.character.beast-tribe-reputation'; break;
            case 'r1': expandedPath = 'character.relic-gear.zodiac'; break;
            case 'r2': expandedPath = 'character.relic-gear.lucis-tools'; break;
            case 'r3': expandedPath = 'character.relic-gear.anima'; break;
            case 'r4': expandedPath = 'character.relic-gear.eureka'; break;
            case 'r5': expandedPath = 'character.relic-gear.resistance'; break;
            case 'r6': expandedPath = 'character.relic-gear.skysteel-tools'; break;
