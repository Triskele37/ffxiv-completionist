...
import { Crafting_Log_Armorer_Ishgard_Restoration_Restoration_3 } from "./restoration-3";
import { Crafting_Log_Armorer_Ishgard_Restoration_Skysteel_Tools } from "./skysteel-tools";
...
export const Crafting_Log_Armorer_Ishgard_Restoration = function(parent) {
    return new DataGroup("Ishgard Restoration", parent).initializeSubGroups([
        ...
        Crafting_Log_Armorer_Ishgard_Restoration_Restoration_3,
        Crafting_Log_Armorer_Ishgard_Restoration_Skysteel_Tools,
