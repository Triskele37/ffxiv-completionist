...
import { Crafting_Log_Carpenter_Master_Recipes_Master_Recipes_8 } from "./mr-8";
import { Crafting_Log_Carpenter_Master_Recipes_Other_Master_Recipes } from "./other";

export const Crafting_Log_Carpenter_Master_Recipes = function(parent) {
    return new DataGroup("Master Recipes", parent).initializeSubGroups([
        ...
        Crafting_Log_Carpenter_Master_Recipes_Master_Recipes_8,
