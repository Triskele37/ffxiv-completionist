...
export const Crafting_Log_Carpenter_Collectables_61_70 = function(parent) {
...
const tasks = [
    {
        level: "62",
        name: "Raefied Beech Composite Bow",
        mat1: "2 Beech Lumber",
    ...
    {
        level: "66",
        name: "Rarefied Pine Cane",
        mat1: "2 Pine Lumber",
        mat2: "Kudzu Cloth",
        mat3: "Growth Formula Eta",
        mat4: "X",
        mat5: "X",
        mat6: "X",
    ...
    {
        level: "68",
        name: "Rarefied Persimmon Bracelets",
    ...
    {
        level: "70",
        name: "Rarefield Zelkova Spinning Wheel",
