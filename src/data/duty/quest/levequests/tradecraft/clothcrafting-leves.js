...
export const Duty_Quests_Levequests_Clothcrafting = function(parent) {
    return new DataGroup("Clothcrafting", parent).initializeTasks(tasks);
};
...
const tasks = [
    ...
    //------------------------------------------------------------------ Large-scale
    {
        ...
        level: "52",
        name: "Soot in My Hair and Scars on My Hands (L)",
        zone: "Ishgard",
        location: "Foundation",
        npc: "Eloin"
    }, {
        ...
        level: "56",
        name: "Through Sashes Come the Ashes (L)",
        zone: "Ishgard",
        location: "Foundation",
        npc: "Eloin"
    }, {
