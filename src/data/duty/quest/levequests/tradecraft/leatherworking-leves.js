...
export const Duty_Quests_Levequests_Leatherworking = function(parent) {
    return new DataGroup("Leatherworking", parent).initializeTasks(tasks);
};
...
const tasks = [
    ...
    //------------------------------------------------------------------ Large-scale
    {
        ...
        level: "52",
        name: "Belting Out the Low Notes (L)",
        zone: "Ishgard",
        location: "Foundation",
        npc: "Eloin"
    }, {
        ...
        level: "56",
        name: "Training Is Only Skin-tight (L)",
        zone: "Ishgard",
        location: "Foundation",
        npc: "Eloin"
    }, {
